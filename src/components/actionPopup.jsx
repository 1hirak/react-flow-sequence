      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
        <div className="flex items-center justify-between bg-blue-600 text-white px-6 py-3">
          <h2 className="text-lg font-medium">
            {activeAction === 'email' ? 'Add Email' : 
             activeAction === 'delay' ? 'Add Delay' : 
             'Select Action'}
          </h2>
          <button 
            onClick={()=>{handleClose();localHandleClose()}}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e)=>localDispatch({type:"email",payload:{input:"title",value:e.target.value}})}
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between pt-4">
                ...
                <button
                  ...
                  onClick={()=>dispatch({type:"delay",payload:state})}
                >
                  Set Delay
                </button>
              </div>
